...
/* harmony import */ var _modules_bulletchart_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_modules_bulletchart_js__WEBPACK_IMPORTED_MODULE_0__);
...
var sfbulletchart = function sfbulletchart(exports) {
  ...
  /** @class */
  function (_super) {
    __extends$1(ContainerPadding, _super);
  ...
  function (_super) {
    ...
    __decorate$5([sf.base.Property('Series')], LegendSettings.prototype, "mode", void 0);
  ...
  function () {
    ...
    BaseLegend.prototype.renderLegend = function (chart, legend, legendBounds, redraw) {
      ...
      this.legendRegions = [];
      this.maxItemHeight = Math.max(this.legendCollections[0].textSize.height, legend.shapeHeight); // For new legend navigation
    ...
    BaseLegend.prototype.getLinearLegend = function (legendBounds, chart, legend, legendTranslateGroup) {
      ...
      var startTextSize = sf.svgbase.measureText(startLabel, legend.textStyle);
      var endTextSize = sf.svgbase.measureText(endLabel, legend.textStyle);
      ...
      var textOptions = new sf.svgbase.TextOption('', startLabelX, startLabelY, '', startLabel);
      ...
      textElement$1(chart.renderer, textOptions, legend.textStyle, fontcolor, legendTranslateGroup, false, false, false, false, // tslint:disable-next-line:align
      null, this.currentPageNumber && isCanvas ? new sf.svgbase.Rect(0, -this.translatePage(null, this.currentPageNumber - 1, this.currentPageNumber), 0, 0) : null);
      textOptions = new sf.svgbase.TextOption('', endLabelX, endLabelY, '', endLabel);
    ...
    BaseLegend.prototype.renderSymbol = function (legendOption, group, i) {
      ...
      if (!isCanvas) {
        group.appendChild(drawSymbol(legendOption.location, shape, new sf.svgbase.Size(this.legend.shapeWidth, this.legend.shapeHeight), legendOption.url, symbolOption, this.accessbilityText, this.chart.renderer, null, this.isBulletChartControl, control));
      } else {
        regionPadding = -this.translatePage(null, this.currentPageNumber - 1, this.currentPageNumber);
        drawSymbol(legendOption.location, shape, new sf.svgbase.Size(this.legend.shapeWidth, this.legend.shapeHeight), '', symbolOption, this.accessbilityText, this.chart.renderer, this.currentPageNumber ? new sf.svgbase.Rect(0, regionPadding, 0, 0) : null, this.isBulletChartControl, control);
        this.legendRegions.push({
          rect: new sf.svgbase.Rect(legendOption.location.x, legendOption.location.y, this.legend.shapeWidth, this.legend.shapeHeight + regionPadding),
          index: i
        });
      }
      ...
      if (shape === 'Line' && legendOption.markerVisibility && legendOption.markerShape !== 'Image' || legendOption.type === 'Doughnut') {
        ...
        if (!isCanvas) {
          // eslint-disable-next-line max-len
          group.appendChild(drawSymbol(legendOption.location, shape, new sf.svgbase.Size(this.legend.shapeWidth / 2, this.legend.shapeHeight / 2), '', symbolOption, this.accessbilityText, null, null, this.isBulletChartControl, control));
        } else {
          drawSymbol(legendOption.location, shape, new sf.svgbase.Size(this.legend.shapeWidth / 2, this.legend.shapeHeight / 2), '', symbolOption, this.accessbilityText, this.chart.renderer, this.currentPageNumber ? new sf.svgbase.Rect(0, -this.translatePage(null, this.currentPageNumber - 1, this.currentPageNumber), 0, 0) : null, this.isBulletChartControl, control);
        }
      }
    };
    /**
  ...
  function (_super) {
    ...
    __decorate$4([sf.base.Property('')], Range.prototype, "legendImageUrl", void 0);
    ...
    BulletChart.prototype.renderDataLabel = function () {
      ...
      if (this.dataLabel.enable) {
        for (var i = 0, len = Object.keys(this.dataSource).length; i < len; i++) {
          ...
          var labelSize = sf.svgbase.measureText(labelText, this.dataLabel.labelStyle); // tslint:disable-next-line:no-string-literal
