...
/* harmony import */ var _modules_dropdowntree_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_modules_dropdowntree_js__WEBPACK_IMPORTED_MODULE_0__);
...
var sfdropdowntree = function sfdropdowntree(exports) {
  ...
  function (_super) {
    ...
    DropDownTree.prototype.render = function () {
      ...
      this.hasTemplate = this.itemTemplate || this.headerTemplate || this.footerTemplate || this.actionFailureTemplate || this.noRecordsTemplate;
      this.renderComplete();
    };
    ...
    DropDownTree.prototype.updateRemainTemplate = function (remainElement, remaining, // eslint-disable-next-line
    ...
    DropDownTree.prototype.getOverflowVal = function (index) {
      ...
      return sf.base.getValue(this.treeSettings.loadOnDemand ? this.fields.text : 'text', selectedData);
    };
          ...
          if (htmlAttr === 'class') {
            ...
            if (htmlAttr.indexOf('data') === 0 || validateAttr.indexOf(htmlAttr) > -1) {
              ...
              if (htmlAttr === 'placeholder') {
                sf.inputs.Input.setPlaceholder(this.htmlAttributes[htmlAttr], this.inputEle);
              } else {
