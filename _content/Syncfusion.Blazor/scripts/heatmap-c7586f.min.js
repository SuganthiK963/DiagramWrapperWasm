...
/* harmony import */ var _modules_heatmap_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_modules_heatmap_js__WEBPACK_IMPORTED_MODULE_0__);
...
var sfheatmap = function sfheatmap(exports) {
  ...
  function () {
    ...
    CellColor.prototype.orderbyOffset = function (offsets) {
      ...
      returnCollection.isLabel = true; // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  function (_super) {
    ...
    Axis.prototype.calculateDateTimeAxisLabel = function (heatmap) {
      ...
      var dateParser = heatmap.intl.getDateParser(option); // eslint-disable-next-line @typescript-eslint/ban-types
    ...
    Axis.prototype.getTotalLabelLength = function (min, max) {
      ...
      switch (this.intervalType) {
        ...
        case 'Hours':
          difference = Math.abs(minimum.getTime() - maximum.getTime()); // eslint-disable-next-line no-case-declarations
  ...
  function () {
    ...
    AxisHelper.prototype.calculateAxisSize = function (rect) {
      ...
      for (var i = 0, len = axisCollection.length; i < len; i++) {
        ...
        axis.rect = sf.base.extend({}, rect, null, true);
    ...
    AxisHelper.prototype.drawXAxisBorder = function (axis, parent, rect, lableX, width, index) {
      ...
      var endX;
      var endY;
      endY = startY + (axis.opposedPosition ? -(axis.maxLabelSize.height + padding) : axis.maxLabelSize.height + padding); // eslint-disable-next-line prefer-const
    ...
    AxisHelper.prototype.drawYAxisBorder = function (axis, parent, rect, lableY, height, index) {
      ...
      var endX;
      var endY;
      endX = startX + (!axis.opposedPosition ? -(axis.maxLabelSize.width + padding) : axis.maxLabelSize.width + padding); // eslint-disable-next-line prefer-const
      ...
      for (var index = 0; index < axis.axisLabelSize; index++) {
        ...
        if (Number(firstDate) <= date && Number(secondDate) >= date) {
          if (axis.intervalType === 'Minutes' || axis.intervalType === 'Hours') {
            ...
            var numberOfDays = Math.round(Math.abs((firstDate.getTime() - secondDate.getTime()) / oneDay)); // eslint-disable-next-line
  ...
  function () {
    ...
    Series.prototype.isCellValueInRange = function (dataXIndex, dataYIndex) {
      ...
      for (var i = 0; i < this.heatMap.toggleValue.length; i++) {
        var maxValue = void 0;
        var minValue = i === 0 && !this.heatMap.isColorRange ? this.heatMap.dataSourceMinValue : this.heatMap.isColorRange ? this.heatMap.toggleValue[i].startValue : this.heatMap.toggleValue[i].value;
    ...
    Series.prototype.setTextAndColor = function (dataXIndex, dataYIndex) {
      this.bubbleColorValue = [];
      var adaptData = this.heatMap.dataSourceSettings; // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    Series.prototype.getCurrentRect = function (x, y) {
      ...
      rectX = rectX === 0 ? 1 : rectX; // eslint-disable-next-line prefer-const
  ...
  function () {
    ...
    TwoDimensional.prototype.processDataSource = function (dataSource) {
      ...
      var yLength = dataLength > labelLength ? dataLength : labelLength; // eslint-disable-next-line @typescript-eslint/no-explicit-any
      ...
      for (var z = axis[1].valueType === 'Category' ? axis[1].min : 0; z < (this.heatMap.paletteSettings.colorGradientMode === 'Column' ? xLength : yLength); z++) {
        ...
        if (this.heatMap.paletteSettings.colorGradientMode === 'Column' && this.heatMap.paletteSettings.type === 'Gradient') {
          ...
          for (var i = 0; i < tempVariable.length; i++) {
            if (_typeof(tempVariable[i]) === 'object' && tempVariable[i] !== null || undefined || '') {
    ...
    TwoDimensional.prototype.processDataArray = function (tempCloneData, tempIndex, z, cloneDataIndex) {
      if (this.heatMap.bubbleSizeWithColor) {
        if (tempCloneData[tempIndex] && !sf.base.isNullOrUndefined(tempCloneData[tempIndex][z]) && _typeof(tempCloneData[tempIndex][z]) === 'object') {
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
        ...
        if (tempCloneData[tempIndex] && (tempCloneData[tempIndex][z] || tempCloneData[tempIndex][z] === 0 && tempCloneData[tempIndex][z].toString() !== '')) {
          if (_typeof(tempCloneData[tempIndex][z]) === 'object') {
  ...
  function () {
    ...
    Adaptor.prototype.getDateAxisCollection = function (min, max, intervalType, increment) {
      ...
      var dateParser = this.heatMap.intl.getDateParser(option); // eslint-disable-next-line @typescript-eslint/ban-types
    ...
    Adaptor.prototype.getMinMaxValue = function (dataSource, adapData, xAxis, yAxis) {
      ...
      if (data.length > 0) {
        this.adaptiveXMinMax.min = !sf.base.isNullOrUndefined(xAxis.minimum) ? xAxis.minimum : adapData.isJsonData ? // eslint-disable-next-line @typescript-eslint/no-explicit-any
        data[0][label[0]] : data[0][0];
        this.adaptiveYMinMax.min = !sf.base.isNullOrUndefined(yAxis.minimum) ? yAxis.minimum : adapData.isJsonData ? // eslint-disable-next-line @typescript-eslint/no-explicit-any
        data[0][label[1]] : data[0][1];
        this.adaptiveXMinMax.max = !sf.base.isNullOrUndefined(xAxis.maximum) ? xAxis.maximum : adapData.isJsonData ? // eslint-disable-next-line @typescript-eslint/no-explicit-any
        data[0][label[0]] : data[0][0];
        this.adaptiveYMinMax.max = !sf.base.isNullOrUndefined(yAxis.maximum) ? yAxis.maximum : adapData.isJsonData ? // eslint-disable-next-line @typescript-eslint/no-explicit-any
        data[0][label[1]] : data[0][1];
      }

      for (var dataIndex = 0; dataIndex < data.length; dataIndex++) {
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        var xDataIndex = adapData.isJsonData ? data[dataIndex][label[0]] : data[dataIndex][0]; // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    Adaptor.prototype.getSplitDataValue = function ( // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  function () {
    ...
    ExportUtils.prototype["export"] = function (type, fileName, orientation) {
      ...
      var height = controlValue.height; // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  function (_super) {
    ...
    HeatMap.prototype.wireEvents = function () {
      ...
      window.addEventListener(sf.base.Browser.isTouch && 'orientation' in window && 'onorientationchange' in window ? 'orientationchange' : 'resize', this.heatMapResize.bind(this)); // eslint-disable-next-line
    ...
    HeatMap.prototype.unWireEvents = function () {
      ...
      // eslint-disable-next-line
      var isIE11Pointer = sf.base.Browser.isPointer;
      var start = sf.base.Browser.touchStartEvent; // eslint-disable-next-line
    ...
    HeatMap.prototype.heatMapMouseClick = function (e) {
      var pageX;
      var pageY; // eslint-disable-next-line
            ...
            if (this.selectedCellCount === this.selectedMultiCellCollection.length) {
              ...
              if (!this.enableCanvasRendering) {
                for (var j = 0; j < this.selectedMultiCellCollection.length; j++) {
                  ...
                  if (rectElement) {
                    var index = rectElement.id.replace(this.element.id + '_HeatMapRect_', ''); // eslint-disable-next-line
    ...
    __decorate([sf.base.Complex({
      position: 'Right'
    }, LegendSettings)], HeatMap.prototype, "legendSettings", void 0);
