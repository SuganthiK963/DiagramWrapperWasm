...
/* harmony import */ var _modules_maskedtextbox_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_modules_maskedtextbox_js__WEBPACK_IMPORTED_MODULE_0__);
...
var sfmaskedtextbox = function sfmaskedtextbox(exports) {
  ...
  function wireEvents() {
    ...
    sf.base.EventHandler.add(this.element, 'mousedown', maskInputMouseDownHandler, this);
    sf.base.EventHandler.add(this.element, 'mouseup', maskInputMouseUpHandler, this);
  ...
  function unwireEvents() {
    ...
    sf.base.EventHandler.remove(this.element, 'mousedown', maskInputMouseDownHandler);
    sf.base.EventHandler.remove(this.element, 'mouseup', maskInputMouseUpHandler);
  ...
  function strippedValue(element, maskValues) {
    ...
    if (maskValue !== this.promptMask) {
      for (var i = 0; i < this.customRegExpCollec.length; i++) {
        ...
        if (!checkMask) {
          if (maskValue[i] !== this.promptChar && !sf.base.isNullOrUndefined(this.customRegExpCollec[k]) && ( // eslint-disable-next-line no-underscore-dangle
          this._callPasteHandler || !sf.base.isNullOrUndefined(this.regExpCollec[this.customRegExpCollec[k]]) || this.customRegExpCollec[k].length > 2 && this.customRegExpCollec[k][0] === '[' && this.customRegExpCollec[k][this.customRegExpCollec[k].length - 1] === ']' || !sf.base.isNullOrUndefined(this.customCharacters) && !sf.base.isNullOrUndefined(this.customCharacters[this.customRegExpCollec[k]])) && maskValue !== '') {
            value += maskValue[i];
          }
        }
  ...
  function maskInputPasteHandler(event) {
    ...
    if (this.mask && !this.readonly) {
      ...
      setElementValue.call(this, ''); // eslint-disable-next-line no-underscore-dangle
      ...
      setTimeout(function () {
        ...
        _this.maskKeyPress = false; // eslint-disable-next-line no-underscore-dangle
  ...
  exports.maskInputMouseDownHandler = maskInputMouseDownHandler;
  exports.maskInputMouseUpHandler = maskInputMouseUpHandler;
