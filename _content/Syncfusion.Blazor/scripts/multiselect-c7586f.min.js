...
var sfmultiselect = function sfmultiselect(exports) {
  ...
  function (_super) {
    ...
    MultiSelect.prototype.removelastSelection = function (e) {
      ...
      if (this.allowCustomValue && (value !== 'false' && customValue === false || !sf.base.isNullOrUndefined(customValue) && customValue.toString() === 'NaN')) {
        customValue = value;
      }
    ...
    MultiSelect.prototype.checkForCustomValue = function (query, fields) {
      ...
      if (this.allowCustomValue && dataChecks) {
        ...
        if (typeof customData !== 'string' && typeof customData !== 'number' && typeof customData !== 'boolean') {
          ...
          if (typeof sf.base.getValue(this.fields.value ? this.fields.value : 'value', customData) === 'number') {
            sf.base.setValue(field.value, Math.random(), dataItem);
          } else {
