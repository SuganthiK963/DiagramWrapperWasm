...
/* harmony import */ var _modules_progressbar_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_modules_progressbar_js__WEBPACK_IMPORTED_MODULE_0__);
...
var sfprogressbar = function sfprogressbar(exports) {
  ...
  function () {
    ...
    ProgressAnimation.prototype.doStripedAnimation = function (element, _progress3, value) {
      var _this = this;
      ...
      animation.animate(element, {
        ...
        progress: function progress() {
          ...
          if (!_progress3.destroyIndeterminate) {
            _this.doStripedAnimation(element, _progress3, value);
          }
        }
      });
    };
    ...
    ProgressAnimation.prototype.doCircularAnimation = function (x, y, radius, progressEnd, totalEnd, element, _progress4, thickness, delay, startValue, previousTotal, active) {
      ...
      var startPos = !sf.base.isNullOrUndefined(startValue) ? startValue : start;
      var endPos = !sf.base.isNullOrUndefined(startValue) ? totalEnd - previousTotal : totalEnd;
    ...
    ProgressAnimation.prototype.doAnnotationAnimation = function (circularPath, _progress7, previousEnd, previousTotal) {
      ...
      var startValue = !sf.base.isNullOrUndefined(previousEnd) ? previousEnd : start;
      var endValue = !sf.base.isNullOrUndefined(previousEnd) ? totalEnd - previousTotal : totalEnd;
  ...
  function (_super) {
    ...
    ProgressAnnotation.prototype.destroy = function () {// Destroy method performed here
    };
  ...
  function () {
    ...
    Linear.prototype.renderLinearBuffer = function (progress) {
      ...
      var linearBufferGroup = progress.renderer.createGroup({
    ...
    Linear.prototype.renderLinearLabel = function () {
      ...
      var linearLabelGroup = progress.renderer.createGroup({
      ...
      var linearValue = progress.value < progress.minimum || progress.value > progress.maximum ? 0 : Math.round(labelValue); // Checking the font color
      ...
      if (!argsData.cancel) {
        ...
        if (progress.labelOnTrack) {
          ...
          if (textAlignment === 'Near') {
            ...
            posX = progress.enableRtl ? progress.progressRect.x + textSize.width / 2 : progress.progressRect.x + progress.progressRect.width - textSize.width / 2;
  ...
  function () {
    ...
    Circular.prototype.renderCircularTrack = function () {
      ...
      var strokeWidth = progress.enablePieProgress ? 0 : progress.trackThickness || progress.themeStyle.circularTrackThickness;
      ...
      this.isRange = this.progress.rangeColors[0].color !== '' || this.progress.rangeColors[0].start !== null || this.progress.rangeColors[0].end !== null;
      var option = new sf.svgbase.PathOption(progress.element.id + '_Circulartrack', fill, strokeWidth, stroke, progress.themeStyle.trackOpacity, '0', circularPath);
    ...
    Circular.prototype.renderCircularProgress = function (previousEnd, previousTotalEnd, refresh) {
      ...
      var option = new sf.svgbase.PathOption(progress.element.id + '_Circularprogress', fill, strokeWidth, stroke, progress.themeStyle.progressOpacity, '0', circularPath);
      progress.progressWidth = progress.renderer.drawPath(option).getTotalLength();
    ...
    Circular.prototype.renderCircularBuffer = function (progress, radius, progressTotalAngle) {
      ...
      var segmentWidth;
      var totalAngle;
      var circularBufferGroup = progress.renderer.createGroup({
      ...
      var stroke = this.checkingCircularProgressColor();
      var fill = progress.enablePieProgress ? stroke : 'none';
      var strokeWidth = progress.enablePieProgress ? 0 : progress.progressThickness || progress.themeStyle.circularProgressThickness;
      var option = new sf.svgbase.PathOption(progress.element.id + '_Circularbuffer', fill, strokeWidth, stroke, progress.themeStyle.bufferOpacity, '0', circularPath);
    ...
    Circular.prototype.renderCircularLabel = function () {
      ...
      var progress = this.progress;
      var labelText = progress.labelStyle.text;
      var circularLabelGroup = progress.renderer.createGroup({
  ...
  function (_super) {
    ...
    ProgressBar.prototype.destroy = function () {
      ...
      this.removeSvg(); // tslint:disable-next-line:no-any
    ...
    __decorate([sf.base.Property(true)], ProgressBar.prototype, "labelOnTrack", void 0);
