  ...
  function () {
    ...
    VirtualContentRenderer.prototype.onDataReady = function () {
      ...
      if (this.parent.options.enableVirtualMaskRow) {
        ...
        if (yValue_1 != 0 && this.startIndex) yValue_1 = yValue_1 - this.parent.options.pageSize * (this.parent.options.rowHeight ? this.parent.options.rowHeight : 35) - 10;else yValue_1 = this.startIndex ? yValue_1 : 0;
        setTimeout(function () {
