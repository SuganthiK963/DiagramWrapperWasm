...
window.sfBlazor.HeatMap = function () {
  ...
  function () {
    ...
    SfHeatMap.prototype.getElementBounds = function (element) {
      ...
      var parentOffsetHeight = element.parentElement ? element.parentElement.offsetHeight : height; // eslint-disable-next-line @typescript-eslint/no-explicit-any

      var elementRect = element.getBoundingClientRect();
      return {
        width: width,
        height: height,
        parentHeight: parentOffsetHeight,
  ...
  var HeatMap = {
    ...
    destroy: function destroy(element, dotnetRef) {
      if (element && element.blazorInstance) {
