...
window.sfBlazor.ListView = function () {
  ...
  function () {
    ...
    SfListView.prototype.selectItemHandler = function (cancelArgs) {
      if (!cancelArgs) {
        // tslint:disable-next-line
        var target = this.mouseEvent.target;
        var li = sf.base.closest(target.parentNode, '.' + LISTITEM);
        this.setSelectLI(li, this.mouseEvent);
      }
    };
    ...
    SfListView.prototype.nestedListHandler = function (li, e) {
  ...
  var listView = {
    ...
    selectItemHandler: function selectItemHandler(element, cancelArgs) {
      // tslint:enable
      element.blazor__instance.selectItemHandler(cancelArgs);
    },
