  ...
  function () {
    ...
    SfMaskedTextBox.prototype.updateMask = function (inputChar, startIndex) {
      ...
      if (!this.ismultipledelete) {
        ...
        if (startIndex < this.options.hiddenMask.length && startIndex >= 0) {
          if (this.options.hiddenMask[startIndex] === '<') {
            isLower = true;
            isUpper = false;
            this.options.hiddenMask = this.options.hiddenMask.replace(this.options.hiddenMask[startIndex], '');
          } else if (this.options.hiddenMask[startIndex] === '>') {
            isUpper = true;
            isLower = false;
            this.options.hiddenMask = this.options.hiddenMask.replace(this.options.hiddenMask[startIndex], '');
          } else if (this.options.hiddenMask[startIndex] === '|') {
          ...
          if (startIndex < this.options.promptMask.length) {
            if (this.options.promptMask[startIndex] === this.options.promptCharacter) {
              if (checkRegex.test(inputChar)) {
                var modifiedinputchar = this.getLetterCase(inputChar, isUpper, isLower);
    ...
    SfMaskedTextBox.prototype.getLetterCase = function (inputChar, upperCase, lowerCase) {
      var inputCharacter = upperCase ? inputChar.toUpperCase() : lowerCase ? inputChar.toLowerCase() : inputChar;
