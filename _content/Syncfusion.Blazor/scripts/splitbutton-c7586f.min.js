...
var sfsplitbutton = function sfsplitbutton(exports) {
  ...
  function (_super) {
    ...
    DropDownButton.prototype.clickHandler = function (e) {
      ...
      if (sf.base.closest(trgt, '[id="' + this.element.id + '"]')) {
        if (!this.createPopupOnClick || this.target) {
          this.getPopUpElement().classList.contains('e-popup-close') ? this.openPopUp(e) : this.closePopup(e);
    ...
    __decorate$1([sf.base.Property(false)], DropDownButton.prototype, "createPopupOnClick", void 0);
  ...
  function (_super) {
    ...
    __decorate([sf.base.Property(false)], SplitButton.prototype, "createPopupOnClick", void 0);
